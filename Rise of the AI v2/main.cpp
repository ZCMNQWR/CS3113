...
void initialise()
{
    ...
    g_display_window = SDL_CreateWindow("Rise of the Slimes!",
        ...
        switch (event.type) {
            ...
            case SDL_KEYDOWN:
                switch (event.key.keysym.sym) {
                    ...
                    case SDLK_SPACE:
                        // ————— JUMPING ————— //
                        if (g_current_scene->get_state().player->get_collided_bottom() && g_current_scene->get_state().player->get_is_active())
                        {
